...
def generate_examples(account):
    ...
    # --- CLASSE 4 (Tiers) ---
        ...
        if acc_id.startswith('40'): # Fournisseurs
            ...
            examples.append({
                "title": "Comptabilisation de la paie (Bulletin)",
                "rows": [
            ...
            examples.append({
                "title": "Charges patronales et salariales",
                "rows": [
                    {"account": "645 Charges de sécurité sociale", "debit": "1 200", "credit": ""},
                    {"account": "421 (Part salariale retenue)", "debit": "600", "credit": ""},
                    {"account": f"{acc_id} {label}", "debit": "", "credit": "1 800"}
                ]
            })
