...
const SUBSCRIPTION_BLACKLIST_DB_FILENAME = "SubscriptionBlacklist.db";
...
function initializeDatabase() {
  ...
  const dbs = [
      ...
      { name: SUBSCRIPTION_BLACKLIST_DB_FILENAME, default: { bans: [] } }
  ];
...
function readSubscriptionBlacklistDb() { return readDb(SUBSCRIPTION_BLACKLIST_DB_FILENAME, { bans: [] }); }
function writeSubscriptionBlacklistDb(d) { writeDb(SUBSCRIPTION_BLACKLIST_DB_FILENAME, d); }
...
function getInvitationEmailTemplate(senderName) {
    ...
    <tr><td align="center" style="padding:20px;">
        ...
        <div style="background:#0a0a0a;border:2px solid #D4AF37;border-radius:10px;padding:20px;margin:25px 0;text-align:center;">
            ...
            <a href="https://chaouiengage.netlify.app" style="background:#D4AF37;color:#000;text-decoration:none;padding:10px 20px;border-radius:5px;font-weight:bold;">Créer mon compte</a>
        </div>
