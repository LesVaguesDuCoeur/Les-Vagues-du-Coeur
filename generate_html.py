    ...
    <script>
        ...
        function selectAccount(id) {
            ...
            while(curr) {
                ...
                // Also apply accordion logic up the tree?
                // Usually we only want to collapse siblings of the node we clicked.
                // But if we jump to a node deep in the tree via search/link, we might want to collapse other branches?
                // For now, let's just ensure the path is open.
